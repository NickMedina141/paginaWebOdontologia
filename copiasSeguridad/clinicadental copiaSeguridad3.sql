...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-05-2025 a las 02:43:42
...
(1, 123456, 'sensibilidad dental', 'limpieza dental', 'ibuprofeno 400 mg', 'penicilina', 'Hipertension'),
(2, 1003674922, 'Bruxismo', 'blanqueamiento', 'Amoxicilina 500mg', 'latex', 'diabetes'),
(3, 1066885489, 'sensibilidad dental', 'ortodoncia', 'amoxicilina 500mg', 'penicilina', 'Hipertension');
...
(1065868488, 'nicolas', 'bohorquez', '3106866612', 1, 'administrador');
...
(123456, 'nicolas', 'bohorquz', 1, '1234567890', NULL, '2005-03-30 00:00:00'),
...
(1, 'limpieza Dental', 'eliminación profesional de placa y sarro para mantener sus dientes y encías saludables.', 50000),
(2, 'Endodoncia', 'ni idea, no soy odontologo', 5000000);
