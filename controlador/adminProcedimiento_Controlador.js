document.addEventListener('DOMContentLoaded', function() {
  ...
  const patientId = url.get("cedula");
...
async function SubirProcedimientos(){
  ...
  try{
    ...
    if(resultado.success){
      ...
      //redireccionar a la vista de adminProcedimiento.php
      window.location.href = `../vista/adminProcedimientos.php?cedula=${cedula}`;
    }
    else{
...
//editar y eliminar, para que no haya error en consola
