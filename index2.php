        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <div class="d-flex align-items-center">
            <?php if (isset($_SESSION['email'])): ?>
              ...
              <div class="d-flex align-items-center">
                <?php if ($rol == "2") { ?>
                  <a href="vista/panelPaciente.php?cedula=<?php echo $_SESSION['cedula']; ?>"><button class="btn btn-outline-primary rounded-pill px-4 py-2"><span>Entrar</span></button></a>
                <?php } elseif ($rol == "1") { ?>
                  <a href="vista/panelOdontologo.php?cedula=<?php echo $_SESSION['cedula']; ?>"><button class="btn btn-outline-primary rounded-pill px-4 py-2"><span>Entrar</span></button></a>

                <?php } else { ?>
                  <a href="vista/panelAdministrador.php"><button class="btn btn-outline-primary rounded-pill px-4 py-2"><span>Entrar</span></button></a>

                <?php  } ?>

                <a class="btn btn-danger" href="controlador/cerrarsesion.php"><span class="Entrar" data-bs-toggle="modal" data-bs-target="#inicio">Salir</span></a>
            ...
            <div class="d-flex flex-column flex-sm-row gap-3">
              ...
              <div class="d-flex align-items-center">
                ...
                <?php else: ?>
                  ...
                  <?php } else { ?>
                    <a class="nav-link" href="#" style="color: #000000;">
                      <button class="btn btn-primary"><span class="Entrar" data-bs-toggle="modal" data-bs-target="#inicio"></span></button></a>
                  <?php } ?>
    ...
    <div class="container">
      <div class="d-flex flex-column align-items-center text-center">
        ...
        <p class="mb-2">
          ...
          </script> Clínica Dental Dra. Diana Noriega. Todos los derechos reservados.
        </p>
