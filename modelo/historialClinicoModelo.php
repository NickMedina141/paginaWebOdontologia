...
//     public function obtenerDatos($cedula) {
//         $cedula = $this->conexion->real_escape_string($cedula);
//         $sql = "SELECT h.paciente_cedula, h.padecimientos, h.tratamientos, h.medicamentos, 
//                        h.antecedentes AS historial, h.alergias, p.nombres, p.apellidos 
//                 FROM historial h 
//                 JOIN pacientes p ON h.paciente_cedula = p.cedula
//                 WHERE h.paciente_cedula = '$cedula'";
...
//     echo json_encode($datos);
// } else {
//     echo json_encode(["error" => true, "message" => "Cédula no proporcionada"]);
// }
...
// // escapar la cedula para evitar inyecciones de tipo SQL
// $cedula = $conexion->real_escape_string($_GET["cedula"]);

// //consulta
// // $sql = "SELECT * FROM historial where cedula = '$cedula'";
// $sql = "SELECT h.paciente_cedula, h.padecimientos, h.tratamientos, h.medicamentos, h.antecedentes AS historial, 
//     h.alergias,p.nombres, p.apellidos FROM historial h JOIN pacientes p ON h.paciente_cedula = p.cedula
//     WHERE h.paciente_cedula = '$cedula'";
